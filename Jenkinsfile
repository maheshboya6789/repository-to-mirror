  ...
  // steps {
   //  withSonarQubeEnv('Sonar') {
    ...
    //}
        ...
        {
            steps{
       nexusArtifactUploader artifacts: [[artifactId: 'vprofile-v1', classifier: '', file: 'target/vprofile-v1.war', type: 'war']], credentialsId: 'nexu-id', groupId: 'vprofile-v1', nexusUrl: 'http://18.221.20.8:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'mavenrepo', version: '$BUILD_ID'
         }
        }
