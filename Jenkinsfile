...
//}
        ...
        {
            steps{
        nexusArtifactUploader artifacts: [[artifactId: 'vprofile-v1', classifier: 'hello', file: 'target/vprofile-v1.war', type: 'war']], credentialsId: 'nexu-id', groupId: 'vprofile-v1', nexusUrl: '18.222.119.48:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'mavenrepo', version: '$BUILD_ID'], credentialsId: 'nexu-id', groupId: 'mygroup', nexusUrl: 'http://18.222.119.48:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'mavenrepo', version: '$BUILD_ID'   
         }
        }
